...
def parser(
    *,
    default_pressure_level_policy: str = "hpa-aligned",
    include_reconstruction_options: bool = True,
    ...
    if include_reconstruction_options:
        result.add_argument(
            "--reconstruction-netcdf",
            action="store_true",
            help=(
                "Also write original, reconstructed and signed-difference fields "
                "to NetCDF on the original HDF5 grid"
            ),
        )
